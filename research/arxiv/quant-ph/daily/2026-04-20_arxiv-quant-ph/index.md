...
**数据来源**: arXiv API (export.arxiv.org/api/query)  
**运行模式**: production（正式版）  
**详细页限制**: unlimited（无上限）  
...
- **论文总数**: 58 篇（New submissions，不含 Cross-lists / Replacements）
- **详细解读**: 根据相关性动态生成（production 模式：高/中相关均生成）
- **重点方向**: 中性原子量子纠错、擦除检测、准粒子制备、硅量子处理单元
...
|------|----------|------|------|--------|--------|
| 1 | [2604.16292](https://arxiv.org/abs/2604.16292) | Fast, High-Fidelity Erasure Detection of Dual-Rail Qubits with Symmetrically Cou... | Hung et al. | 高 | [详解](papers/2604.16292.html) |
...
| 3 | [2604.16285](https://arxiv.org/abs/2604.16285) | How to unitarily map between any two pure states with a single closed-form expon... | Bradshaw et al. | 低 | - |
| 4 | [2604.16283](https://arxiv.org/abs/2604.16283) | Boson correlations are spurious for classical states | Salazar et al. | 低 | - |
| 5 | [2604.16276](https://arxiv.org/abs/2604.16276) | Aziz and Howl's Gravity-Induced Entanglement Channel is Essentially Classical Me... | Xue et al. | 低 | - |
...
*[production 模式：以下所有论文使用统一完整格式，无压缩、无省略]*
...
**一句话核心问题**: 本文核心问题：Erasure qubits are a promising platform for implementing hardware-efficient quantum error correction?

**AI 快评**: 这是一篇实验论文，Erasure qubits are a promising platform for implementing hardware-efficient quantum error correction  Realizing the error-correction advantages of this encoding requires frequent mid-circuit erasure checks that are fast, high-fidelity, and scalable. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。

**相关性**: 高  
**与你的主线关系**: 与用户研究主线（中性原子量子计算/量子纠错/可扩展系统）相关。
**标签**: 量子纠错, 超导量子, 量子控制, 可扩展系统, 物理硬件  
...
**一句话核心问题**: 本文核心问题：We compute thermodynamic properties of dilute Bose gases using non-perturbative approximations of the two-particle irreducible (2PI) effective action?

**AI 快评**: 这是一篇理论论文，We compute thermodynamic properties of dilute Bose gases using non-perturbative approximations of the two-particle irreducible (2PI) effective action  It is shown how to systematically renormalise the self-consistent descriptions beyond conventional Gaussian approximations such as Hartree-Fock-Bogoliubov theory. 偏向基础物理/理论，与当前主线距离较远。
...
**一句话核心问题**: 本文核心问题：It is well-known that any two pure quantum states (in the same Hilbert space) can be mapped to any other using unitary transformations?

**AI 快评**: 这是一篇理论论文，It is well-known that any two pure quantum states (in the same Hilbert space) can be mapped to any other using unitary transformations  However, previous approaches to this problem required two explicit bases for the Hilbert space, one each for the initial and target states, and thus their complexity necessarily scales with the dimension of the Hilbert space. 偏向基础物理/理论，与当前主线距离较远。
...
**一句话核心问题**: 本文核心问题：We show that boson correlations from quantum states with a Glauber-Sudarshan representation of their density matrix which provides a well-behaved prob?

**AI 快评**: 这是一篇实验论文，We show that boson correlations from quantum states with a Glauber-Sudarshan representation of their density matrix which provides a well-behaved probability distribution -- including coherent states, thermal states, and all states that can be deemed classical -- are a manifestation of the Simpson paradox: they are spurious correlations from statistical (ensemble) averages over uncorrelated measurements made in varying geometries, due to a process of symmetry-breaking as a confounding factor  Bosonic correlations encoded by the wavefunction appear to be formed in the geometry assumed, which however is not that of the statistical ensemble but varies from realization to realization. 偏向基础物理/理论，与当前主线距离较远。
...
**作者**: Hanyu Xue, Ziqian Tang, Chen Yang et al.  
...
**一句话核心问题**: 本文核心问题：Aziz and Howl argued that a classical gravitational field can generate quantum entanglement through a quantum-field-theoretic channel mediated by virt?

**AI 快评**: 这是一篇理论/方法论文，Aziz and Howl argued that a classical gravitational field can generate quantum entanglement through a quantum-field-theoretic channel mediated by virtual matter propagation  However, their claimed channel is more naturally and accurately understood as semiclassical wavepacket motion in an external gravitational field, rather than as a distinctively quantum-field-theoretic entangling effect. 偏向基础物理/理论，与当前主线距离较远。
...
**作者**: Christopher N. Gilbreth, Dmytro Filin, Marianna S. Safronova et al.  
...
**一句话核心问题**: 本文核心问题：Engineering large-scale quantum computers which simultaneously provide high-fidelity quantum operations, low memory errors, low crosstalk, and reasona?

**AI 快评**: 这是一篇实验论文，Engineering large-scale quantum computers which simultaneously provide high-fidelity quantum operations, low memory errors, low crosstalk, and reasonable resource usage remains an outstanding challenge across quantum computing platforms  In trapped ions, progress has largely focused on alkaline-earth and ytterbium ions, whose simple electronic structures facilitate control over their internal state. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。

**相关性**: 高  
**与你的主线关系**: 与用户研究主线（中性原子量子计算/量子纠错/可扩展系统）相关。
**标签**: 离子阱, 量子控制  
**进入详细页**: 是 → [详细解读](papers/2604.16274.html)

---

### 2604.16236 — Long-term Performance Analysis of a Commercial QKD Device Under Real-world Deployment Conditions

**作者**: Alisson Tezzin, Gustavo M. Uhdre, Oscar Martins et al.  
...
**一句话核心问题**: 本文核心问题：Quantum key distribution (QKD) has reached a commercially viable stage, with several companies offering hardware systems designed for operational depl?

**AI 快评**: 这是一篇实验论文，Quantum key distribution (QKD) has reached a commercially viable stage, with several companies offering hardware systems designed for operational deployment  Evaluating the performance of commercial QKD devices under real-world deployment conditions is essential for users seeking to understand the practical limitations and operational reliability of these systems. 偏向基础物理/理论，与当前主线距离较远。
...
**作者**:  Members of the HRL Quantum Team,  Collaborators,  : et al.  
...
**一句话核心问题**: 本文核心问题：Commercially-relevant quantum computers will require large numbers of high-performing qubits that can be manufactured, integrated, and controlled at s?

**AI 快评**: 这是一篇实验论文，Commercially-relevant quantum computers will require large numbers of high-performing qubits that can be manufactured, integrated, and controlled at scale  Silicon exchange-only (EO) qubits are a strong candidate modality due to their control-signal simplicity and compatibility with advanced semiconductor manufacturing, but questions remain around the achievability of sufficiently low noise and a scalable control and wiring solution. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
**作者**: Mattia Morgavi, Peter Majcen, Marco Rigobello et al.  
...
**一句话核心问题**: 本文核心问题：We introduce a method for the selective preparation and detection of quasiparticle wave packets, based on creation operators that generate dressed, lo?

**AI 快评**: 这是一篇算法/协议论文，We introduce a method for the selective preparation and detection of quasiparticle wave packets, based on creation operators that generate dressed, localized excitations on top of interacting vacua of (quasi-)one-dimensional quantum lattice theories  This method exploits maximally localized Wannier functions (MLWFs) constructed from quasiparticle bands at intermediate system sizes, enabling the construction of unitary local dressed creation operators. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
**作者**: Chen Zhao, Casey Duckering, Andi Gu et al.  
...
**一句话核心问题**: 本文核心问题：Quantum error correction is widely believed to be essential for large-scale quantum computation, but the required qubit overhead remains a central cha?

**AI 快评**: 这是一篇理论/方法论文，Quantum error correction is widely believed to be essential for large-scale quantum computation, but the required qubit overhead remains a central challenge  Quantum low-density parity-check codes can substantially reduce this overhead through high-rate encodings, yet finite-size instances with practical logical error rates often achieve encoding rates only around or below $1/10$. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
**作者**: Alberto Hijano, Tero T. Heikkilä  
...
**一句话核心问题**: 本文核心问题：Proportional-Integral-Derivative (PID) control is used for automatically regulating a measurable quantity to a desired setpoint?

**AI 快评**: 这是一篇实验论文，Proportional-Integral-Derivative (PID) control is used for automatically regulating a measurable quantity to a desired setpoint  It is widely used in different types of classical control electronics. 偏向基础物理/理论，与当前主线距离较远。
...
**作者**: Maximilian Hollendonner, Fedor Dzmitryevich Hrunski, Daniel Scheller et al.  
...
**一句话核心问题**: 本文核心问题：Silicon vacancy (VSi) centers in 4H silicon carbide have emerged as a highly promising platform for semiconductor-based quantum technologies, combinin?

**AI 快评**: 这是一篇理论/方法论文，Silicon vacancy (VSi) centers in 4H silicon carbide have emerged as a highly promising platform for semiconductor-based quantum technologies, combining excellent spin and optical properties with an industrial-grade, CMOS-compatible material  As these defects are increasingly integrated into practical quantum devices, they inevitably encounter lattice strain. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
**作者**: Linlin Ye, Zhaoqi Wu, Shao-Ming Fei  
...
**一句话核心问题**: 本文核心问题：Quantum coherence plays a pivotal role in quantum algorithms?

**AI 快评**: 这是一篇算法/协议论文，Quantum coherence plays a pivotal role in quantum algorithms  We study the coherence dynamics of the evolved states in Simon's quantum algorithm based on Tsallis relative $α$ entropy and $l_{1,p}$ norm. 对量子计算领域有参考价值。
...
**作者**: Nis-Luca van Hülst, Mario Guillaume Cecile, Hai-Yen Van et al.  
...
**一句话核心问题**: 本文核心问题：Turbulent thermal convection governs heat transport in systems ranging from stellar interiors to industrial heat exchangers?

**AI 快评**: 这是一篇实验论文，Turbulent thermal convection governs heat transport in systems ranging from stellar interiors to industrial heat exchangers  Two-dimensional Rayleigh-Bénard convection serves as a paradigm for these flows, reproducing key features such as thin boundary layers, large-scale circulation, and sustained plume dynamics. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
**作者**: Matthew S. Winnel, Sergio Juárez, Chithrabhanu Perumangatt et al.  
...
**一句话核心问题**: 本文核心问题：Quantum protocols require classical signaling, and when classical signals propagate faster than quantum ones, standard rate-loss limits can be surpass?

**AI 快评**: 这是一篇实验论文，Quantum protocols require classical signaling, and when classical signals propagate faster than quantum ones, standard rate-loss limits can be surpassed  We introduce an all-photonic measurement-device-independent quantum key distribution protocol that exceeds the single-repeater bound without error correction. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.16165 — Single-Satellite Quantum Repeater Performance Analysis

**作者**: Cameron Paterson, Jasminder S. Sidhu, Thomas Brougham et al.  
**原链接**: https://arxiv.org/abs/2604.16165  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Space-based entanglement distribution has the potential to extend the range of quantum communication beyond that achievable through optical fibres tha?

**AI 快评**: 这是一篇理论/方法论文，Space-based entanglement distribution has the potential to extend the range of quantum communication beyond that achievable through optical fibres that are constrained by exponential losses  Quantum repeaters have been proposed to mitigate the effects of channel losses for both fibre and satellite networks. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.16164 — A unified framework for efficient quantum simulation of nonlinear spectroscopy

**作者**: Long Xiong, Xiaoyang Wang, Xiaoxia Cai et al.  
**原链接**: https://arxiv.org/abs/2604.16164  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Nonlinear spectroscopy is a cornerstone of quantum science, providing unique access to multi-point correlations, quantum coherence, and couplings that?

**AI 快评**: 这是一篇实验论文，Nonlinear spectroscopy is a cornerstone of quantum science, providing unique access to multi-point correlations, quantum coherence, and couplings that are invisible to linear methods  However, classical simulation of these phenomena is fundamentally limited by the exponential growth of the Hilbert space, and practical quantum algorithms for the nonlinear regime have remained largely unexplored. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.16144 — Gravitationally induced wave-function collapse from dynamical bifurcation

**作者**: C. A. S. Almeida  
**原链接**: https://arxiv.org/abs/2604.16144  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：We propose an effective non-relativistic framework in which wave-function collapse emerges as a deterministic dynamical instability induced by gravita?

**AI 快评**: 这是一篇理论/方法论文，We propose an effective non-relativistic framework in which wave-function collapse emerges as a deterministic dynamical instability induced by gravitational self-interaction and regulated by short-distance repulsion  The dynamics is described by a nonlinear Schrödinger equation supplemented by a phenomenological repulsive sector ensuring regularity at high densities. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.16140 — Characterizing all non-Hermitian degeneracies using algebraic approaches: Defectiveness and asymptotic behavior

**作者**: Sharareh Sayyad, Grigory A. Starkov  
**原链接**: https://arxiv.org/abs/2604.16140  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：The presence of degeneracies plays a crucial role in describing the behavior of non-Hermitian (NH) systems?

**AI 快评**: 这是一篇实验论文，The presence of degeneracies plays a crucial role in describing the behavior of non-Hermitian (NH) systems  In these systems, there are two key types of degeneracies: $n$-bolical degeneracies, which are analogous to Hermitian degeneracies, and various forms of exceptional points, each associated with different orders that correspond to sizes of the Jordan blocks. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.16139 — Converting non-Hermitian degeneracies of any order: Hierarchies of exceptional points and degeneracy manifolds

**作者**: Grigory A. Starkov, Sharareh Sayyad  
**原链接**: https://arxiv.org/abs/2604.16139  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：The emergence of various types of degeneracies plays a crucial role in optimizing and engineering different physical phenomena in non-Hermitian physic?

**AI 快评**: 这是一篇实验论文，The emergence of various types of degeneracies plays a crucial role in optimizing and engineering different physical phenomena in non-Hermitian physics  In our work, we focus on the derogatory Exceptional Points (EPs), which are characterized by multiple Jordan blocks corresponding to the same eigenvalue. 偏向基础物理/理论，与当前主线距离较远。
...
**作者**: Si Wang, Thomas G. Kiely, Dorothee Tell et al.  
**原链接**: https://arxiv.org/abs/2604.16137  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Symmetry-based classification of quantum phases of matter is one of the most foundational organizing principles in physics; however, an analogous fram?

**AI 快评**: 这是一篇实验论文，Symmetry-based classification of quantum phases of matter is one of the most foundational organizing principles in physics; however, an analogous framework for mixed, decohered quantum states has only begun to emerge  A central new concept is strong-to-weak spontaneous symmetry breaking (SW-SSB), a sharp transition in mixed quantum states that is invisible to any observable linear in the density matrix and that has since been predicted across a broad class of open and monitored quantum systems. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.16136 — Quantum Noise Suppression Beyond the Standard Quantum Limit in a Hybrid Magnonic Optomechanical System

**作者**: Alolika Roy, Amarendra K. Sarma  
**原链接**: https://arxiv.org/abs/2604.16136  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：We theoretically study how quantum measurement noise can be engineered in a hybrid cavitymagnomechanical platform for precision force sensing?

**AI 快评**: 这是一篇实验论文，We theoretically study how quantum measurement noise can be engineered in a hybrid cavitymagnomechanical platform for precision force sensing  The proposed configuration consists of a driven optomechanical cavity, with a movable mirror on one side plus a fixed semi-transparent mirror on the other side, coupled to a magnon mode, with an OPA placed inside the cavity. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.16107 — Entanglement and photoelectron holography in dissociative photoionization: molecular quantum eraser

**作者**: Sebastian Hell, Paul Winter, Martin Gärttner et al.  
**原链接**: https://arxiv.org/abs/2604.16107  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：In a double-slit experiment with a bipartite system, the visibility of interference fringes depends on the availability of which-way information?

**AI 快评**: 这是一篇实验论文，In a double-slit experiment with a bipartite system, the visibility of interference fringes depends on the availability of which-way information  Here, we report the formation of a Bell-like state of photoelectron and residual ion in the multiphoton dissociative ionization of the D$_2$ molecule. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.16102 — Exact Steady State of a One-end Driven XXZ Spin Chain with Boundary Field

**作者**: V. Popkov, T. Prosen  
**原链接**: https://arxiv.org/abs/2604.16102  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20

**原摘要**: We find an exact nonequilibrium steady state of an open dissipatively driven XXZ spin-1/2 chain with source or sink spin bath at one end and an arbitrary boundary field at the other end.

**一句话核心问题**: 本文核心问题：We find an exact nonequilibrium steady state of an open dissipatively driven XXZ spin-1/2 chain with source or sink spin bath at one end and an arbitr?

**AI 快评**: 这是一篇理论/方法论文，We find an exact nonequilibrium steady state of an open dissipatively driven XXZ spin-1/2 chain with source or sink spin bath at one end and an arbitrary boundary field at the other end . 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.16101 — Quantum-Resistant Quantum Teleportation

**作者**: Xin Jin, Nitish Kumar Chandra, Mohadeseh Azari et al.  
**原链接**: https://arxiv.org/abs/2604.16101  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：We propose a quantum-resistant quantum teleportation (QRQT) framework protected by post-quantum cryptography (PQC) to secure the classical correction ?

**AI 快评**: 这是一篇实验论文，We propose a quantum-resistant quantum teleportation (QRQT) framework protected by post-quantum cryptography (PQC) to secure the classical correction channel, which is vulnerable to quantum adversaries  By applying PQC to the classical control bits, QRQT eliminates the classical attack surface of quantum teleportation. 对量子计算领域有参考价值。
...
### 2604.16071 — Security Framework for Quantum Distance-Bounding

**作者**: Kevin Bogner, Aysajan Abidin, Dave Singelee et al.  
**原链接**: https://arxiv.org/abs/2604.16071  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Distance-bounding (DB) protocols let a verifier upper-bound a prover's physical distance by timing rapid challenge-response exchanges?

**AI 快评**: 这是一篇实验论文，Distance-bounding (DB) protocols let a verifier upper-bound a prover's physical distance by timing rapid challenge-response exchanges  Quantum communication promises simpler DB protocols with stronger security guarantees, yet existing quantum distance-bounding (QDB) proposals are analysed in ad-hoc models and, to the best of our knowledge, lack a common game-based treatment of standard fraud attacks. 对量子计算领域有参考价值。
...
### 2604.16051 — Comment on "A General Framework for Constructing Local Hidden-state Models to Determine the Steerability"

**作者**: Nick von Selzam, Florian Marquardt  
**原链接**: https://arxiv.org/abs/2604.16051  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：We point out that the method presented in a recent arXiv article by Jia et al?

**AI 快评**: 这是一篇理论/方法论文，We point out that the method presented in a recent arXiv article by Jia et al  (arXiv:2512. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.16023 — MacWilliams Identities for Intrinsic Quantum Codes

**作者**: Eric Kubischta, Ian Teixeira  
**原链接**: https://arxiv.org/abs/2604.16023  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：We develop an intrinsic enumerator framework for quantum error correction in unitary representations of symmetry groups?

**AI 快评**: 这是一篇理论论文，We develop an intrinsic enumerator framework for quantum error correction in unitary representations of symmetry groups  An intrinsic quantum code is a subspace of a representation $V$ of a group $G$, and errors are organized by the decomposition of the conjugation representation on $\mathcal{L}(V)$ into isotypic subspaces. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15971 — A Modular Cryogenic Link for Microwave Quantum Communication Over Distances of Tens of Meters

**作者**: Josua D. Schär, Simon Storz, Paul Magnard et al.  
**原链接**: https://arxiv.org/abs/2604.15971  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Quantum technologies promise a radically new way to solve classically intractable computing problems?

**AI 快评**: 这是一篇实验论文，Quantum technologies promise a radically new way to solve classically intractable computing problems  Superconducting circuits as a platform are at the forefront of this field. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15953 — Finite-Time Thermodynamics of an Autonomous Information Machine

**作者**: Wanyan Chen, Miao Chen, Yu-Han Ma  
**原链接**: https://arxiv.org/abs/2604.15953  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：While externally driven information engines are well understood, the thermodynamic constraints of their autonomous counterparts remain an open questio?

**AI 快评**: 这是一篇理论/方法论文，While externally driven information engines are well understood, the thermodynamic constraints of their autonomous counterparts remain an open question  Here, we investigate the finite-time operation of an autonomous machine functioning as both an information eraser and a refrigerator, revealing that its irreversibility is bounded by the transient information geometry. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.15924 — Ultrafast Current Switching from Quantum Geometry in Semimetals

**作者**: Youngjae Kim, Sejoong Kim, Jun-Won Rhim  
**原链接**: https://arxiv.org/abs/2604.15924  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Technological progress towards next-generation electronics critically relies on achieving faster switching with reduced energy consumption?

**AI 快评**: 这是一篇实验论文，Technological progress towards next-generation electronics critically relies on achieving faster switching with reduced energy consumption  Because device operation speeds are fundamentally constrained by the intrinsic properties of constituent materials, identifying systems with inherently superior switching capabilities is essential. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15920 — Local qubit invariants on quantum computer

**作者**: Szilárd Szalay, Frédéric Holweck  
**原链接**: https://arxiv.org/abs/2604.15920  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20

**原摘要**: We present two general methods to implement quantum circuits for the direct measuring of local unitary invariants on quantum computers. We work these out for important three-qubit invariants, and also demonstrate these on the IBM Quantum Platform for important entanglement measures of three qubits.

**一句话核心问题**: 本文核心问题：We present two general methods to implement quantum circuits for the direct measuring of local unitary invariants on quantum computers?

**AI 快评**: 这是一篇实验论文，We present two general methods to implement quantum circuits for the direct measuring of local unitary invariants on quantum computers  We work these out for important three-qubit invariants, and also demonstrate these on the IBM Quantum Platform for important entanglement measures of three qubits. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.15912 — Sensing of Low-Frequency Electric Fields Using Rydberg EIT within the Fisher Information Framework

**作者**: Tianyu Zhou, Haipeng Xie, Xin Wang  
**原链接**: https://arxiv.org/abs/2604.15912  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Rydberg atoms, which possess exceptionally large electric dipole moments, offer a promising route for electric field sensing as well as metrology trac?

**AI 快评**: 这是一篇实验论文，Rydberg atoms, which possess exceptionally large electric dipole moments, offer a promising route for electric field sensing as well as metrology traceable to the International System of Units (SI); however, current research predominantly focuses on the microwave (MW) regime, leaving the quasi-direct current (quasi-DC) and low-frequency bands, ubiquitous in power systems, largely unexplored  In this paper, we present a theoretical investigation into low-frequency electric field detection. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15895 — Digital Predistortion for Flux Control of Tunable Superconducting Qubits

**作者**: Dharun Venkateswaran, Felice Francesco Tafuri, Yuanzheng Paul Tan et al.  
**原链接**: https://arxiv.org/abs/2604.15895  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Flux-tunable superconducting qubits rely on fast flux control pulses to implement two-qubit entangling quantum gates, a key building block for quantum?

**AI 快评**: 这是一篇实验论文，Flux-tunable superconducting qubits rely on fast flux control pulses to implement two-qubit entangling quantum gates, a key building block for quantum algorithms  However, distortion effects introduced by non-ideal control electronics, parasitic components, and the cryogenic quantum chip response can all degrade the gate fidelity. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15888 — Enhancing Neural-Network Variational Monte Carlo through Basis Transformation

**作者**: Zhixuan Liu, Dongheng Qian, Jing Wang  
**原链接**: https://arxiv.org/abs/2604.15888  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Neural-network variational Monte Carlo (NNVMC) has emerged as a powerful tool for solving quantum many-body problems, yet systematic pathways for impr?

**AI 快评**: 这是一篇理论/方法论文，Neural-network variational Monte Carlo (NNVMC) has emerged as a powerful tool for solving quantum many-body problems, yet systematic pathways for improving its accuracy remain largely heuristic  Here, we introduce a physically motivated basis transformation for NNVMC that enhances variational expressivity without increasing the complexity of the neural-network ansatz itself. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15886 — Asymptotic optimality of Grover-Radhakrishnan-Korepin algorithm

**作者**: Kun Zhang, Kang-Yuan Chen, Xiao-Hui Wang et al.  
**原链接**: https://arxiv.org/abs/2604.15886  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Grover's algorithm is a cornerstone of quantum algorithms and is strictly optimal in oracle-query complexity?

**AI 快评**: 这是一篇理论论文，Grover's algorithm is a cornerstone of quantum algorithms and is strictly optimal in oracle-query complexity  While the full search problem admits no further improvement, one may trade accuracy for speed in the partial search problem, where the task is to identify only the block containing the target item. 对量子计算领域有参考价值。
...
### 2604.15867 — Approximate Cosine Similarity Estimation via an Angle-Encoding Hadamard Test

**作者**: Hiroshi Ohno  
**原链接**: https://arxiv.org/abs/2604.15867  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：The Hadamard test is a standard quantum primitive for estimating inner products and expectation values, but in data-processing settings its practical ?

**AI 快评**: 这是一篇实验论文，The Hadamard test is a standard quantum primitive for estimating inner products and expectation values, but in data-processing settings its practical utility is often limited by the cost of preparing amplitude-encoded quantum states  In this study, we investigate an angle-encoding variant of the Hadamard test for estimating cosine similarity between normalized real-valued vectors. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.15858 — Module Lattice Security (Part I): Unconditional Verification of Weber's Conjecture for $k \le 12$

**作者**: Ming-Xing Luo  
**原链接**: https://arxiv.org/abs/2604.15858  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Weber's conjecture (1886) governs three aspects of lattice-based cryptography: the solvability of the Principal Ideal Problem, the freeness of modules?

**AI 快评**: 这是一篇理论论文，Weber's conjecture (1886) governs three aspects of lattice-based cryptography: the solvability of the Principal Ideal Problem, the freeness of modules over rings of integers, and the tightness of worst-case-to-average-case reductions in Ring-LWE (R-LWE) and Module-LWE (MLWE)  Existing verifications for $k \ge 9$ rely on Generalized Riemann Hypothesis (GRH). 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.15836 — A Practical Semi-Quantum Signature Protocol with Improved Eavesdropping Detection

**作者**: Zengyu Pang, Hua Xiang  
**原链接**: https://arxiv.org/abs/2604.15836  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Semi-quantum signature (SQS) schemes aim to enable quantum signature functionality in scenarios where only a subset of participants possess full quant?

**AI 快评**: 这是一篇算法/协议论文，Semi-quantum signature (SQS) schemes aim to enable quantum signature functionality in scenarios where only a subset of participants possess full quantum capabilities, thereby improving practical deployability while preserving quantum security advantages  Within this framework, we present a practical SQS protocol based on Bell states. 对量子计算领域有参考价值。
...
### 2604.15820 — Hilbert Space Fragmentation and Gauge Symmetry

**作者**: Thea Budde, Marina Kristć Marinković, Joao C. Pinto Barros  
**原链接**: https://arxiv.org/abs/2604.15820  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：The Hamiltonian formulation of lattice gauge theories plays a central role in quantum simulations of gauge theories, and understanding their spectrum ?

**AI 快评**: 这是一篇理论论文，The Hamiltonian formulation of lattice gauge theories plays a central role in quantum simulations of gauge theories, and understanding their spectrum and other properties is expected to become crucial in the upcoming years  The relevant Hamiltonians in this framework possess local symmetry at each lattice site and may exhibit higher-form symmetries. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15799 — Spectral design principles for local-excitation retention in impurity-assisted atomic arrays

**作者**: Junpei Oba  
**原链接**: https://arxiv.org/abs/2604.15799  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Enhanced local-excitation retention in atomic arrays allows to exploit cooperative radiative effects to suppress emission and prolong excited-state li?

**AI 快评**: 这是一篇理论论文，Enhanced local-excitation retention in atomic arrays allows to exploit cooperative radiative effects to suppress emission and prolong excited-state lifetimes  We consider an impurity-assisted setting involving a single storage atom being initially excited and study the survival of local excitation under neither write nor retrieval fields. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.15790 — Holographic Stirling engines and the route to Carnot efficiency

**作者**: Nikesh Lilani, Manus R. Visser  
**原链接**: https://arxiv.org/abs/2604.15790  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：We compute the efficiency of the reversible Stirling engine, with and without regeneration, for a broad class of working substances including Van der ?

**AI 快评**: 这是一篇理论/方法论文，We compute the efficiency of the reversible Stirling engine, with and without regeneration, for a broad class of working substances including Van der Waals fluids, quantum ideal gases (Bose and Fermi), Bose-Einstein condensates, thermal conformal field theories (CFTs), and holographic CFTs  Regeneration acts as an internal heat recycling mechanism that enhances efficiency by reducing the net heat exchange with external reservoirs. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.15775 — Federated Learning with Quantum Enhanced LSTM for Applications in High Energy Physics

**作者**: Abhishek Sawaika, Durga Pritam Suggisetti, Udaya Parampalli et al.  
**原链接**: https://arxiv.org/abs/2604.15775  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Learning with large-scale datasets and information-critical applications, such as in High Energy Physics (HEP), demands highly complex, large-scale mo?

**AI 快评**: 这是一篇实验论文，Learning with large-scale datasets and information-critical applications, such as in High Energy Physics (HEP), demands highly complex, large-scale models that are both robust and accurate  To tackle this issue and cater to the learning requirements, we envision using a federated learning framework with a quantum-enhanced model. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15763 — Machine-learning-assisted material and geometry characterization from Casimir force measurement

**作者**: Hideo Iizuka, Shanhui Fan  
**原链接**: https://arxiv.org/abs/2604.15763  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：A broadband electromagnetic source is important for scientific and technological applications?

**AI 快评**: 这是一篇实验论文，A broadband electromagnetic source is important for scientific and technological applications  Quantum vacuum fluctuations, which manifest most prominently in the Casimir effect, provide a fundamentally broadband electromagnetic source. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.15755 — Optically detected magnetic resonance of nitrogen-vacancy centers in diamond using two-photon excitation

**作者**: Lam T. Nguyen, Khanh Kieu  
**原链接**: https://arxiv.org/abs/2604.15755  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：We demonstrate the use of two-photon excitation for observing the ground state optically detected magnetic resonance (ODMR) of nitrogen-vacancy center?

**AI 快评**: 这是一篇实验论文，We demonstrate the use of two-photon excitation for observing the ground state optically detected magnetic resonance (ODMR) of nitrogen-vacancy centers in diamonds at room temperature  An ultrafast femtosecond laser at 1040 nm was used for excitation, while fluorescence signal read out was achieved through a combination of a PMT and a lock-in amplifier. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15752 — Quantifying Uhlmann curvature from Yang-Mills action and its implications in quantum multiparameter estimation

**作者**: Yi-Lin Ge, Bing-Shu Hu, Ling-Yun Deng et al.  
**原链接**: https://arxiv.org/abs/2604.15752  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：The geometry of quantum states has profound implications in quantum multiparameter estimation?

**AI 快评**: 这是一篇实验论文，The geometry of quantum states has profound implications in quantum multiparameter estimation  While the Riemannian structure of quantum state space is well understood, the full understanding of the curvature structure of mixed quantum states is still an open problem. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.15693 — Observable-Guided Generator Selection for Improving Trainability in Quantum Machine Learning with a $ \mathfrak{g} $-Purity Interpretation under Restricted Settings

**作者**: Hiroshi Ohno  
**原链接**: https://arxiv.org/abs/2604.15693  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：To study generator design for parameterized unitaries in quantum machine learning (QML), we propose an observable-guided generator selection algorithm?

**AI 快评**: 这是一篇实验论文，To study generator design for parameterized unitaries in quantum machine learning (QML), we propose an observable-guided generator selection algorithm for $ n $-qubit Pauli-string generator pools  The proposed method selects generators based on two criteria: maintaining large first-order sensitivity in the gradients and suppressing second-order interference in the Hessian matrix. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.15666 — Explainable quantum regression algorithm with encoded data structure

**作者**: C. -C. Joseph Wang, F. Perkkola, I. Salmenperä et al.  
**原链接**: https://arxiv.org/abs/2604.15666  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Hybrid variational quantum algorithms are promising for solving practical problems, such as combinatorial optimization, quantum chemistry simulation, ?

**AI 快评**: 这是一篇实验论文，Hybrid variational quantum algorithms are promising for solving practical problems, such as combinatorial optimization, quantum chemistry simulation, quantum machine learning, and quantum error correction on noisy quantum computers  However, variational quantum algorithms (derived from randomized hardware-efficient ansatz or adaptive ansatz) become a black box, not trustworthy for model interpretation, and not to mention for application deployment in informing critical decisions. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15653 — Growth of quantum dots by droplet etching epitaxy in molecular beam epitaxy: theory, practice, and review

**作者**: Declan Gossink, Undurti S. Sainadh, Glenn S. Solomon  
**原链接**: https://arxiv.org/abs/2604.15653  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：GaAs quantum dots grown by droplet etching epitaxy are high-quality solid-state sources of quantum light?

**AI 快评**: 这是一篇实验论文，GaAs quantum dots grown by droplet etching epitaxy are high-quality solid-state sources of quantum light  Despite implementation in devices that exploit quantum phenomenon, a comprehensive review on the crystal growth of quantum dots grown by droplet etching epitaxy is absent, unlike for other quantum dot growth techniques such as the related droplet epitaxy method or Stranski-Krastanov growth of InAs quantum dots. 偏向基础物理/理论，与当前主线距离较远。
...
### 2604.15645 — PINNACLE: An Open-Source Computational Framework for Classical and Quantum PINNs

**作者**: Shimon Pisnoy, Hemanth Chandravamsi, Ziv Chen et al.  
**原链接**: https://arxiv.org/abs/2604.15645  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：We present PINNACLE, an open-source computational framework for physics-informed neural networks (PINNs) that integrates modern training strategies, m?

**AI 快评**: 这是一篇理论/方法论文，We present PINNACLE, an open-source computational framework for physics-informed neural networks (PINNs) that integrates modern training strategies, multi-GPU acceleration, and hybrid quantum-classical architectures within a unified modular workflow  The framework enables systematic evaluation of PINN performance across benchmark problems including 1D hyperbolic conservation laws, incompressible flows, and electromagnetic wave propagation. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15626 — Bridge the Gap between Classical and Quantum Neural Networks with Residual Connections

**作者**: Junxu Li  
**原链接**: https://arxiv.org/abs/2604.15626  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：We introduce a Hybrid Quantum Residual Network (HQRN) and establish an exact functional correspondence between its state evolution and the dynamics of?

**AI 快评**: 这是一篇实验论文，We introduce a Hybrid Quantum Residual Network (HQRN) and establish an exact functional correspondence between its state evolution and the dynamics of classical networks with residual connections  When inputs are restricted to the computational basis, the HQRN reduces to its classical analog, enabling the direct translation of optimized classical weights into quantum unitary operations, effectively inheriting the landscape benefits of classical optimization. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15616 — Overcoming the Lamb Shift in System-Bath Models via KMS Detailed Balance: High-Accuracy Thermalization with Time-Bounded Interactions

**作者**: Hongrui Chen, Zhiyan Ding, Ruizhe Zhang  
**原链接**: https://arxiv.org/abs/2604.15616  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：We investigate quantum thermal state preparation algorithms based on system-bath interactions and uncover a surprising phenomenon in the weak-coupling?

**AI 快评**: 这是一篇算法/协议论文，We investigate quantum thermal state preparation algorithms based on system-bath interactions and uncover a surprising phenomenon in the weak-coupling regime  We rigorously prove that, if the system-bath interaction is engineered so that the transition part of the approximate Lindbladian generator satisfies the KMS detailed balance condition, then the unique fixed point of the dynamics can be made arbitrarily close to the Gibbs state in the weak-coupling limit, regardless of the structure of the Lamb shift term. 对量子计算领域有参考价值。
...
### 2604.15605 — Deterministic multiphoton bundle emission via interference-interaction control

**作者**: Jing Tang, Yuangang Deng  
**原链接**: https://arxiv.org/abs/2604.15605  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：The controlled generation of nonclassical light beyond single photons remains a central challenge in quantum optics, due to the difficulty of enhancin?

**AI 快评**: 这是一篇实验论文，The controlled generation of nonclassical light beyond single photons remains a central challenge in quantum optics, due to the difficulty of enhancing multiphoton processes while suppressing lower-order excitations  Here we propose an interference-interaction-engineered scheme for programmable few-photon emission in a cavity-QED system of three atoms coupled to orthogonal cavity modes. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15604 — Many-Body Amplified Nonclassical Photon Emission in Cavity-Coupled Atomic Arrays

**作者**: Tang Jing, Yuangang Deng  
**原链接**: https://arxiv.org/abs/2604.15604  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：The generation of high-performance nonclassical light remains a cornerstone of quantum technologies, yet faces a fundamental trade-off between emissio?

**AI 快评**: 这是一篇实验论文，The generation of high-performance nonclassical light remains a cornerstone of quantum technologies, yet faces a fundamental trade-off between emission purity and brightness  Here, we demonstrate that cavity-mediated many-body spin-exchange interactions provide a route to overcome this constraint by collectively amplifying spectral anharmonicity. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
### 2604.15603 — A Game Theoretic Approach for Optimizing Quantum Error Budget Distribution

**作者**: Asif Akhtab Ronggon, Tasnuva Farheen  
**原链接**: https://arxiv.org/abs/2604.15603  
**发布时间**: 2026-04-17  
**抓取日期**: 2026-04-20
...
**一句话核心问题**: 本文核心问题：Current fault-tolerant quantum compilers allocate error budgets uniformly during resource estimation, causing suboptimal physical resource overhead?

**AI 快评**: 这是一篇实验论文，Current fault-tolerant quantum compilers allocate error budgets uniformly during resource estimation, causing suboptimal physical resource overhead  We optimize this allocation using a potential game formulation, where Nash Equilibrium yields a Pareto-optimal distribution across logical operations, T-state distillation, and rotation synthesis. 与用户主线（中性原子量子计算/量子纠错/可扩展系统）直接相关。
...
**生成方式**: AI 辅助生成，基于公开元数据进行快评，未阅读全文  
**数据来源**: arXiv API (export.arxiv.org/api/query)  
**抓取时间**: 2026-04-20T21:01:54.028071  
**数据完整性**: 58/58 篇完整抓取  
**快评边界**: 只基于标题、摘要、作者、分类等公开元数据  
**运行模式**: production（正式版）  
**详细页策略**: unlimited（无上限）  
**摘要完整性**: 原摘要完整保留，无截断  
**全量覆盖**: 所有论文均进入主页面，统一格式  
**低相关论文处理**: 无压缩，全部论文格式一致  

---

*本日报由 quant-ph 模块根据正式版规则生成 — PROMPT.md / SOURCES.md / PROFILE.md*